...
1. `data`---either a `feature_calculations` object containing the raw feature matrix produced by `purloiner::extract_features` or `theft::calculate_features` or a numeric vector containing the values to be rescaled
